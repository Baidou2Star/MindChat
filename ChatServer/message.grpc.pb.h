...
class ChatService final {
 public:
  ...
  template <class BaseClass>
  class WithCallbackMethod_NotifyChatImgMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_NotifyChatImgMsg() {
      ::grpc::Service::MarkMethodCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::message::NotifyChatImgReq, ::message::NotifyChatImgRsp>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::message::NotifyChatImgReq* request, ::message::NotifyChatImgRsp* response) { return this->NotifyChatImgMsg(context, request, response); }));}
    void SetMessageAllocatorFor_NotifyChatImgMsg(
        ::grpc::MessageAllocator< ::message::NotifyChatImgReq, ::message::NotifyChatImgRsp>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(6);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::message::NotifyChatImgReq, ::message::NotifyChatImgRsp>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_NotifyChatImgMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyChatImgMsg(::grpc::ServerContext* /*context*/, const ::message::NotifyChatImgReq* /*request*/, ::message::NotifyChatImgRsp* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* NotifyChatImgMsg(
      ::grpc::CallbackServerContext* /*context*/, const ::message::NotifyChatImgReq* /*request*/, ::message::NotifyChatImgRsp* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_NotifyAddFriend<WithCallbackMethod_RplyAddFriend<WithCallbackMethod_SendChatMsg<WithCallbackMethod_NotifyAuthFriend<WithCallbackMethod_NotifyTextChatMsg<WithCallbackMethod_NotifyKickUser<WithCallbackMethod_NotifyChatImgMsg<Service > > > > > > > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_NotifyChatImgMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_NotifyChatImgMsg() {
      ::grpc::Service::MarkMethodRawCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->NotifyChatImgMsg(context, request, response); }));
    }
    ~WithRawCallbackMethod_NotifyChatImgMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyChatImgMsg(::grpc::ServerContext* /*context*/, const ::message::NotifyChatImgReq* /*request*/, ::message::NotifyChatImgRsp* /*response*/) override {
