...
/* @@protoc_insertion_point(class_definition:message.TextChatData) */ {
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_chat_time();
  void set_allocated_chat_time(std::string* value);

  private:
  const std::string& _internal_chat_time() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_chat_time(
      const std::string& value);
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void TextChatData::set_chat_time(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chat_time_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:message.TextChatData.chat_time)
}
inline std::string* TextChatData::mutable_chat_time() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* TextChatData::release_chat_time() {
  ...
  return _impl_.chat_time_.Release();
}
inline void TextChatData::set_allocated_chat_time(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
