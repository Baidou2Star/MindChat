...
这个项目是我从"能写代码"到"能设计系统"过程中积累最深的一次实践。从 TCP 粘包处理到跨节点消息通知，从连接池设计到大模型接入，每一个模块都有真实的工程问题倒逼我去学和去解。写它的初衷是：不想只做一个技术演示，而是想验证一个完整的分布式服务在高并发压力下能不能真的稳住。压测数据给了我一个还算满意的答案。
...
 ​  
 # 仅打增量（待办模块）  
 mysql -h 127.0.0.1 -P 33060 -u root -p < "sql备份/patch_todo_llm.sql"
