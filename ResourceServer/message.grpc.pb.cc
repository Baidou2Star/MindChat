...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_NotifyChatImgMsg_(ChatService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void ChatService::Stub::async::NotifyChatImgMsg(::grpc::ClientContext* context, const ::message::NotifyChatImgReq* request, ::message::NotifyChatImgRsp* response, std::function<void(::grpc::Status)> f) {
...
void ChatService::Stub::async::NotifyChatImgMsg(::grpc::ClientContext* context, const ::message::NotifyChatImgReq* request, ::message::NotifyChatImgRsp* response, ::grpc::ClientUnaryReactor* reactor) {
